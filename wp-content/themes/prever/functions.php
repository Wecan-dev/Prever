...
function Contacto() {
  ...
  $labels = array(
    'name'                  => _x( 'Contacto ', 'Post Type General Name', 'prever' ),
    'singular_name'         => _x( 'Contacto', 'Post Type Singular Name', 'prever' ),
    'menu_name'             => __( 'Contacto', 'prever' ),
    'name_admin_bar'        => __( 'Contacto', 'prever' ),
    'archives'              => __( 'Archivo', 'prever' ),
    'attributes'            => __( 'Atributos', 'prever' ),
    'parent_item_colon'     => __( 'Artículo principal', 'prever' ),
    'all_items'             => __( 'Todos los artículos', 'prever' ),
